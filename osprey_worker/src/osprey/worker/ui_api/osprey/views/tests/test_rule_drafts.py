...
def _set_gitlab_backend(monkeypatch: pytest.MonkeyPatch, **overrides: str) -> None:
    defaults = {
        ...
        'OSPREY_GITLAB_PROJECT': 'juliet/osprey-rules',
...
def test_gitlab_submit_happy_path_opens_merge_request(
    ...
    project_url = 'https://gitlab.com/api/v4/projects/juliet%2Fosprey-rules'
    # The rule file path 'rules/new_rule.sml' becomes 'rules%2Fnew_rule.sml' in the URL.
    ...
    with requests_mock_module.Mocker() as m:
        ...
        m.post(
            ...
            status_code=201,
            json={'iid': 7, 'web_url': 'https://gitlab.com/juliet/osprey-rules/-/merge_requests/7'},
        )
    ...
    assert body['url'] == 'https://gitlab.com/juliet/osprey-rules/-/merge_requests/7'
    assert body['main_sml_updated'] is False
            ...
            json=[
                {
                    'iid': 1,
                    'title': 'Add rule X',
                    'web_url': 'https://gitlab.com/juliet/osprey-rules/-/merge_requests/1',
                    'source_branch': 'rule-draft/juliet/X-1',
                    'author': {'username': 'juliet'},
                    'created_at': '2026-07-01T12:00:00Z',
                },
                {
                    'iid': 2,
                    'title': 'Update README',
                    'web_url': 'https://gitlab.com/juliet/osprey-rules/-/merge_requests/2',
